...
class FBlogin extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Facbooklogin(plugin: plugin),
    );
  }
}

//final FacebookLogin plugin;
class Facbooklogin extends StatefulWidget {
  final FacebookLogin plugin;

  const Facbooklogin({Key key, this.plugin}) : super(key: key);

  @override
  _FacbookloginState createState() => _FacbookloginState();
}

class _FacbookloginState extends State<Facbooklogin> {
  String _sdkVersion;
