...
class Crash_anlytic extends StatefulWidget {
  const Crash_anlytic({Key key}) : super(key: key);

  @override
  State<Crash_anlytic> createState() => _Crash_anlyticState();
}

class _Crash_anlyticState extends State<Crash_anlytic>  {
